...
import 오목.SingleGameGUI.MyJPanel;
...
public class TwoPlayerGameGUI extends JFrame {
	...
	*/
	...
	private int id1, id2, first, size;
	...
	public TwoPlayerGameGUI(int id1, int id2, String name1, String name2, int first, int size) {
		super("2인용 오목게임");
	...
	private void initializeComponents() {
		...
		JOptionPane.showMessageDialog(null, "선공 : 흑돌, 후공 : 백돌로 자동 설정됩니다.");
